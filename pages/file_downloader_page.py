...
class FileDownLoader(Base):
    ...
    def download_file_from_downloader_page(self):
        self.download_file(self.FILE_TO_DOWNLOAD)

    @allure.step("Is file downloaded")
    def is_file_downloaded(self) -> bool:
        self.download_file_from_downloader_page()
        target_directory = os.path.join(os.getcwd(), "../download_file")
